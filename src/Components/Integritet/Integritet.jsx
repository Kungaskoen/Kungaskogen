...
const integritet = props => (

  <div className="integritet-container">

    <div className="integritet-image">
      <Image src="images/integritet.jpg" />
    </div>

    <div className="integritet-info">
      <h3>INTEGRITET</h3>
      ...
      <p>i anslutning till köp, serviceärenden och övrig kontakt med Förlagshuset Wasa/ILKA. När du godkänner policyn på hemsidan i samband med köp eller lämnande av uppgifter samtycker du till behandling av dina personuppgifter i enlighet med nedanstående.</p>
      ...
      <p>Dina personuppgifter kan komma att behandlas med stöd av samtycke från dig. Ditt samtycke måste vara frivilligt, specifikt, informerat och innebära ett otvetydigt medgivande för att gälla som rättslig grund. Vi samlar in samtycken från dig som Prenumerant för att kunna administrera uppgifter och erhålla information om dina inköp. Vidare lagras ditt beteende på vår hemsida, ditt intresse av våra erbjudanden och produkter samt din interaktion med Förlagshuset Wasa/ILKA för att kunna</p> fullgöra vårt åtagande att tillhandahålla dig personliga erbjudanden.

      <p>Dina personuppgifter kan även komma att behandlas med stöd av en så kallad intresseavvägning. Detta gäller exempelvis den behandling vi utför för att göra en begränsad segmentering av kunder. Förlagshuset Wasa/ILKA behandlar aldrig känsliga personuppgifter med stöd av en intresseavvägning och utför ingen automatiserad behandling utan samtycke.</p>

      <p>Förlagshuset Wasa/ILKA har i vissa fall en rättslig förpliktelse att behandla personuppgifter, exempelvis för att kunna uppfylla bokförings- och skattelagstiftningens krav. All behandling av personuppgifter sker då i enlighet med lagstadgade krav.</p>

      <h4>8. Hur länge lagrar vi uppgifter om dig?</h4>
      <p>Förlagshuset Wasa/ILKA lagrar dina personuppgifter så länge det krävs för att fullgöra de ändamål som dem samlades in för. Dina personuppgifter kan dock sparas under en längre tid om det är nödvändigt med hänsyn till lagstadgade krav eller för att bevaka Förlagshuset Wasa/ILKA:s rättsliga intressen.</p>

      <p>Som prenumerant lagras dina personuppgifter så länge du samtycker till det.</p>

      <h4>9. Tillgång till lagrade personuppgifter</h4>
      <p>ILKA kan komma att lämna ut personuppgifter till annat bolag som ingår i samma koncern som Förlagshuset Wasa/ILKA samt till samarbetspartners för att uppfylla våra åtaganden och de ändamål som nämnts ovan. För att säkerställa att vi har rätt adressuppgifter till dig kan Förlagshuset Wasa/ILKA även komma att lämna ut dina uppgifter till företag som tillhandahåller tjänster för adressuppdateringar.</p>

      <p>Uppgifter som vidarebefordras till tredje part används endast för att tillhandahålla ovannämnda tjänster till dig, t.ex. speditörer i samband med leverans av varor, mediebyråer för distribution av marknadsföring och kreditupplysnings- eller inkassobyråer för kreditupplysningskontroller, identitetskontroller och indrivning av fordran.</p>

      <p>Vi överför aldrig dina personuppgifter för marknadsföringsändamål till tredje part utanför Förlagshuset Wasa/ILKA–bolagen och våra samarbetspartners. Förlagshuset Wasa/ILKA kan komma att lämna ut dina personuppgifter om det är nödvändigt för att följa gällande lagstiftning eller krav från myndigheter, för att tillvarata Förlagshuset Wasa/ILKA:s rättsliga intressen eller för att upptäcka, förebygga eller uppmärksamma bedrägerier och andra säkerhets- eller tekniska problem.</p>

      <p>Förlagshuset Wasa/ILKA strävar alltid efter att enbart lagra personuppgifter inom EU/EES. Uppgifterna kan komma att överföras och bearbetas i ett land utanför EU/EES (tredje land). Eventuell överföring sker i enlighet med gällande lagstiftning och registrerade som omfattas av överföringen kommer underrättas.</p>

      <h4>10. Hur skyddar vi dina personuppgifter?</h4>
      <p>Vi har vidtagit tekniska och organisatoriska åtgärder för att skydda dina uppgifter från förlust, manipulation och obehörig åtkomst. Vi anpassar fortlöpande våra säkerhetsåtgärder i enlighet med de framsteg och den utveckling som sker på det tekniska området. För att göra kortköp så säkra som möjligt, skickas all information i krypterad form. Detta innebär att informationen överförs via en säker anslutning och att dina personuppgifter inte kan läsas av utomstående. För kortköp arbetar vi med ett auktoriserat betalningsombud som hjälper oss att direkt kontrollera med din bank att kortet är giltigt för köp. Vårt betalningsombud bearbetar dina kortuppgifter i enlighet med den internationella säkerhetsstandarden PCI DSS som utvecklades av kortföretagen VISA, MasterCard, Diners, American Express och JCB. Detta innebär att säkerheten är mycket hög vid bearbetningen av dina kortuppgifter. När du betalar med kort förbehåller vi oss rätten att utföra en identitetskontroll. </p>

      <p>Vid eventuella personuppgiftsincidenter åtar sig Förlagshuset Wasa/ILKA att anmäla detta till ansvarig tillsynsmyndighet (Datainspektionen) utan onödigt dröjsmål och senast inom 72 timmar från det att incidenten har blivit känd. Om en sådan anmälan inte kan ske inom 72 timmar, ska Förlagshuset Wasa/ILKA redogöra för skälen till fördröjningen i anmälan och information lämnas då i omgångar utan otillbörligt vidare dröjsmål.</p>

      <p>Förlagshuset Wasa/ILKA åtar sig att snarast möjligt underrätta dig om du är berörd av en personuppgiftsincident och vidta nödvändiga försiktighetsåtgärder.</p>

      <h4>11. Vilka är dina rättigheter?</h4>
      <p>ILKA kommer på din begäran eller på eget initiativ att rätta, radera, avidentifiera eller komplettera dina uppgifter om de upptäcks vara felaktiga, ofullständiga eller missvisande.</p>

      <p>Som registrerad äger du rätt att begära:</p>

      <p>1. Tillgång till dina personuppgifter. Du har rätt att få ett registerutdrag eller en kopia över vilka personuppgifter ILKA behandlar om dig. Du kan närsomhelst utnyttja denna rätt kostnadsfritt, en gång per kalenderår, genom en skriftligt undertecknad ansökan. Nämnda registerutdrag ska innehålla information om vilka personuppgifter som finns registrerade om dig, ändamålen med behandlingen och till vilka mottagare uppgifterna har lämnats eller ska lämnas ut. Vidare ska registerutdraget innehålla information om var uppgifterna har hämtats ifrån om personuppgifterna inte har samlats in från dig, huruvida uppgifterna är föremål för automatiserat beslutsfattande (inklusive profilering) samt den förutsedda period ILKA avser att lagra uppgifterna eller kriterierna som används för att fastställa denna period. Du har även rätt att få information om de rättigheter som anges nedan.</p>

      <p>2. Rättelse av dina personuppgifter. På begäran kommer Förlagshuset Wasa/ILKA utan onödigt dröjsmål rätta felaktiga eller ofullständiga uppgifter som behandlas om dig.</p>

      <p>3. Radering av dina personuppgifter. Du har rätt att begära att dina personuppgifter tas bort om de inte längre är nödvändiga för det ändamål de samlades in för. Vid ett lagstadgat krav på lagring av dina personuppgifter eller när det finns andra legitima skäl till varför ILKA måste spara dina uppgifter, till exempel obetalda skulder, kan dina personuppgifter inte raderas. Vi kommer då att avsluta den behandling som görs för andra ändamål än att följa lagstiftningen.</p>

      <p>4. Begränsning av behandling. Du har rätt att begära att dina personuppgifter endast får behandlas för vissa avgränsade ändamål. Du kan bland annat begära begränsning när du anser att dina uppgifter är felaktiga och du har begärt rättelse enligt ovan. Under tiden uppgifternas korrekthet utreds kommer dess behandling vara begränsad.</p>

      <p>Om dina personuppgifter finns lagrade hos Förlagshuset Wasa/ILKA har du rätt till dataportabilitet. Det innebär en rätt att under vissa förutsättningar få ut och överföra dina personuppgifter i ett strukturerat, allmänt använt och maskinläsbart format till en annan personuppgiftsansvarig.</p>

      <p>Du kan när som helst kostnadsfritt invända mot att dina personuppgifter behandlas för direkt marknadsföring. Förlagshuset Wasa/ILKA behandlar inte dina personuppgifter för ändamål som rör direkt marknadsföring om du motsätter dig sådan behandling. När har vi mottagit din invändning kommer vi att upphöra med att behandla personuppgifterna för sådant marknadsföringsändamål. Eventuell invändning skickas till idea@ilka.se. Om du har lämnat samtycke till Förlagshuset Wasa/ILKA att lagra och använda dina personuppgifter för marknadsföringsändamål kan du när som helst återkalla nämnda samtycke. Sådan återkallelse kan begränsas till att endast avse del av behandlingen, exempelvis den som rör direkt marknadsföring.</p>

      <p>Som registrerad äger du rätt att inge eventuella klagomål angående behandling av dina personuppgifter till Datainspektionen.</p>

      <p>Du kan kontakta oss antingen genom att skicka ett brev till Förlagshuset Wasa/ILKA kundtjänst, Förlagshuset Wasa/ILKA, Box 4059, 203 11 Malmö Sverige eller mejla till idea@ilka.se. Dina önskemål kommer besvaras av ILKA snarast möjligt och senast inom en månad. Om Förlagshuset Wasa/ILKA inte avser att uppfylla dina önskemål inom den angivna tiden är Förlagshuset Wasa/ILKA skyldiga att motivera varför.</p>

      <h4>12. Användning av cookies och andra spårningstekniker</h4>
      <p>Vår hemsida använder sig av cookies och andra spårningstekniker för att förbättra din onlineupplevelse. Du hittar mer information om detta i vår cookiepolicy.</p>

      <h4>13. Länkar</h4>
      <p>Ibland länkar vi till andra webbplatser. Denna Integritetspolicy gäller enbart vår egen webbplats. När du länkas till annan webbplats bör du läsa den personuppgiftspolicy som gäller för den sidan. Notera att ILKA inte tar ansvar för andra webbplatsers behandling av dina personuppgifter.</p>

      <h4>14. Eventuella ändringar av Förlagshuset Wasa/ILKA:s integritetspolicy</h4>
      <p>Förlagshuset Wasa/ILKA förbehåller sig rätten att när som helst göra ändringar i denna Integritetspolicy. Om Integritetspolicyn ändras kommer Förlagshuset Wasa/ILKA att med rimlig varsel underrätta dig. Ifall du inte godtar den ändrade Integritetspolicyn har du rätt att säga upp avtalet med ILKA innan den träder i kraft. Du kan säga upp avtalet genom att kontakta Förlagshuset Wasa/ILKA.</p>

      <h4>15. Kontaktinformation till personuppgiftsansvarig</h4>

      <p>Vi värnar om våra kunders personuppgifter! Tveka inte att kontakta oss om du har några frågor om hur vi behandlar dina personuppgifter, denna Integritetspolicy eller om du vill begära ett registerutdrag.</p>

      <div className="compact">
        <p>Vår kontaktinformation är:</p>
        <p>ILKA Förskoleprodukter AB</p>
        <p>Box 4059</p>
        <p>203 11 Malmö Sverige</p>
      </div>

      <br/>

      <div className="compact">
        <p>Telefon: 040 120012</p>
        <p>E-post: idea@ilka.se</p>
        <p>Företagsregister: Bolagsverket</p>
        <p>Organisationsnummer: 556903-3961</p>
      </div>
    </div>
  </div>
);
