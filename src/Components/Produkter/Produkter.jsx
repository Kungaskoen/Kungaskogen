    ...
    return (
      <div className="produkter-container">
        ...
        <div className="produkter-intro">
          ...
          <p>Läs om hela matrialet <a href="https://iqpager.quid.eu//books/iqpager/67903qUEQhSL7vEKn1RV6790bre0tPHUd1" target="_blank"><b>Kungaskogen E-katalog</b></a></p>
        </div>

        <h2 className="produkter-header">Produkter – Tema vänskap, djur och natur</h2>
        ...
        <div className="produkt-big">
          ...
          <p>BOK med totalt 48 sidor. Stort liggande format (30 cm x 20 cm) med BILDBEREÄTTELSE om kompisarna Snick och Snack som bygger en koja och träffar nya vänner. 12 st SÅNGER
och NOTER finns med i boken. Vidare ingår 2 CD SKIVOR med ungefärlig speltid på nära 2 timmar. På CD skivorna finns dialoger, berättare, sång och musik (finns också på
APP som man kan spela från Ipad). Paketet innehåller också ACCESS Handledning (nedladdningsmaterial, över 600 sidor på nätet) med fakta, övningar, aktiviteter enligt läroplanens
mål som anknyter till sagans teman. En Ljuddel och en stor avdelning Viktigt lärande finns också med i accessen. </p>
        </div>
        ...
        <div className="produkt-big">
          ...
          <p><b>Art.nr 4683</b> Temapaket Snick och Snack Vännerna i Kungaskogen går på utflykt. ( Vänskap, djur, natur, miljö, livsstil, hållbart, teknik, språk, matte mm)</p>
          <p>BOK med totalt 82 sidor, stort liggande format (30 cm x 20 cm) som är indelad i KOJAN (12 sidor), SKOGEN (26 sidor), HOS GRONILLA (18 sidor) och 19 st SÅNGER och NOTER.
Vidare ingår 3 CD SKIVOR med ungefärlig speltid på nära 3 timmar. På CD skivorna finns dialoger, berättare, sång och musik (finns också på APP som man kan spela från Ipad). Paketet
innehåller också ACCESS Handledning (nedladdningsmaterial, över 600 sidor på nätet) med fakta, övningar, aktiviteter enligt läroplanens mål som anknyter till sagans teman.
En Ljuddel och en stor avdelning Viktigt lärande finns också med i accessen. ???Lyssna på Bitis som berättar om boken???</p>
        </div>
        ...
        <div className="produkt-dolls">
          <div className="doll">
            ...
            <p>Set om 7 st handdockor (ca 30 cm höga) med design och karaktärer till Vännerna i Kungskogen bygger
en koja. Tillverkade i mjukt tygmaterial. CE-märkta enligt EN-71. Dramatisera och lek till sagan om Vännerna
i Kungaskogen med handdockor.</p>
          </div>
          <div className="doll">
            <Image src="images/produkter/handdockor_utflykt.jpg" responsive />
            <p><b>Art.nr 4677 Handdockor Utflykt</b></p>
            <p>Set om 3 st handdockor (groda, fjäril och larv). I boken boken om Utflykt tillkommer
2 nya karaktärer (larven Silke som blir en fjäril och grodan Gronilla). Dramatisera
och lek till sagan om Vännerna i Kungaskogen med handdockor.</p>
          </div>
