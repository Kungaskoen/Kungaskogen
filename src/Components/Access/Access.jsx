      ...
      <div className="access-container">
        <div className="access-image-container">
          ...
          <div className="access-info">
            ...
            <a href="http://wasaplay.se/access/logform.php" target="_blank">Logga in på accessen</a>
        ...
        <div className="access-image-container">
          ...
          <div className="access-info">
            ...
            <a href="https://iqpager.quid.eu//books/iqpager/6744XKjNOE0y4c7TYF0G6744vuAMRCm0nG" target="_blank">E-katalog Access Kungaskogen handledning. Klicka här och läs!</a>
          </div>
      </div>
